...
Usage: basm [options] file
    Options:
    -ap N,         --address-position N         Sets the position of the address within the memory from the MSB. 
                                                Default: 4
	-aw N,         --address-width N            Set the width in bits of the address. Default: 4
	 ...
	 -f FILE,      --filename FILE              Specify to the file to be assembled. Otherwise the last argument is 
                                                used.
     -h,           --help                       Print this message and exit.
	-ip N,         --instruction-position N     Sets the position of the instruction within the memory from the MSB. 
                                                Default: 0
	-iw N,         --instruction-width N        Set the width in bits of the instruction. Default: 4
	 ...
	 -t,           --tokens-only                Only read the file and generate tokens.
     -v N, 	       --v[vvvv]                    Set the log verbosity to N, 0=OFF, 1=FATAL, 2=ERROR, 3=WARNING, 4=INFO, 
                                                5=DEBUG.
 ```